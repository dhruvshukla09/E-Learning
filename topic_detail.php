...
$sql = "SELECT * FROM topics where Id='".$topic."'";
    ...
    <div class="col-sm-8 text-left"> 
      <?php 
          ...
          if ($topics->num_rows > 0) {
              ...
              while($row = $topics->fetch_assoc()) {var_dump($row);die; ?>
                <h1><?php echo $row['Topic_title']; ?></h1>
                <hr>
                ...
                <div class="col-md-4"><a href="Documnets/<?php echo $row['Documnet']; ?>"><?php echo $row['Documnet']; ?></a></div>
